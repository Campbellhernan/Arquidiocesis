<?php
	...
	$conexion = conectar();
	$consulta_ejecutar = "select id_inm, descripcion, modo_adq as id_adq, direccion, metraje, tipo_inm, linderos, fecha, datos_registro, abogado_redactor, estatus, map_position, zona, ".
